...
public class modItems {
    ...
    public static final Item AMETHYST_COPPER_TABLE_BLOCK = new BlockItem(modBlocks.AMETHYST_COPPER_TABLE_BLOCK, new FabricItemSettings());
    ...
    public static void init() {
        ...
        regitem(AMETHYST_COPPER_TABLE_BLOCK,"amethyst_copper_table");
        ...
        ItemGroupEvents.modifyEntriesEvent(enchantre.ENCHANT_REIMAGINED).register(content -> {
            ...
            content.add(AMETHYST_COPPER_TABLE_BLOCK);
